/*=========================================================================
  ...
  Module:    $RCSfile: vtkImageReader4.h,v $
...
//ETX
  ...
  // Should be implemented by all sub-classes of vtkImageReader4.
...
private:
  ...
  void operator=(const vtkImageReader4&);  // Not implemented.
#ifdef _REQUIRE_CHECKSUMS_
  EVP_MD_CTX mdctx;
